...
The combined trashwheel_all dataset contains 1032 observations of 17 variables from three datasets, each representing one dumpster’s collection event from Mr. Trash Wheel, Professor Trash Wheel, or Gwynnda. Important variables include date (the collection date), weight_tons (tons of trash removed), and specific counts such as cigarette butts, plastic bottles, and sports balls. The total weight in tons collected by professor is 246.76, and the total cigarette butts collected by Gwynnda in June 2022 is 18120.
